 ...
 * 
 */
package FetchingImageFromExcel;
...
public class FetchingImagefromExcel {
	 ...
	 * @param args
	 */
	public void ImageFromExcel() throws IOException {
        ...
        File imageFile = new File("D:\\Image\\NormalImage.png");;
        ...
        if(dfs.getWeekdays()[weekday].toString().equalsIgnoreCase("Tuesday") ||  dfs.getWeekdays()[weekday].toString().equalsIgnoreCase("Thursday")){
              sheet0.saveToImage("D:\\Image\\NormalImage.png");
    		  
    		  try (OutputStream os = new FileOutputStream("D:\\PPTX\\Reporting.pptx")) {     
  	            XSLFSlide slide = ppt.createSlide();  
  	            byte[] pictureData = IOUtils.toByteArray(new FileInputStream("D:\\Image\\NormalImage.png"));  
             ...
             BufferedImage image=bufferedImage.getSubimage(10,75,700,420);
             File pathFile = new File("D:\\Image\\CroppedImage.png");
             try (OutputStream os = new FileOutputStream("D:\\PPTX\\Reporting.pptx")) {     
 	            XSLFSlide slide = ppt.createSlide();  
 	            byte[] pictureData = IOUtils.toByteArray(new FileInputStream("D:\\Image\\CroppedImage.png"));  
 	            XSLFPictureData pd = ppt.addPicture(pictureData, XSLFPictureData.PictureType.PNG);  
 	            XSLFPictureShape pic = slide.createPicture(pd);
